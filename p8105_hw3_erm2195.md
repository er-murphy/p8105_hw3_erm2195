...
## Popular Items From the Baking, Dog Food, and Vegetable Aisles
...
<img src="p8105_hw3_erm2195_files/figure-gfm/unnamed-chunk-19-1.png" width="90%" />
...
mims_merged |> 
  ...
  geom_point(alpha = 0.25, size = 0.05) +
  geom_smooth(se = FALSE) + 
  facet_grid(. ~ education) +
  labs(
    title = "Age vs. Total Activity, by Sex and Education Level",
...
<img src="p8105_hw3_erm2195_files/figure-gfm/unnamed-chunk-20-1.png" width="90%" />
