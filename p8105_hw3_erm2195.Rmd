...
instacart |> 
  count(aisle) |> 
  arrange(desc(n)) |> 
  knitr::kable("Most Commonly Ordered-from Aisles")
```
...
instacart |> 
  ...
  filter(rank < 4) |> 
  arrange(desc(n)) |> 
  knitr::kable(label = "Most Popular Baking, Dog Food, and Packaged Fruits/Vegetables Items" )
...
instacart |>
  ...
  knitr::kable(digits = 2, label = "Average Purchase Time Per Day of the Week")
